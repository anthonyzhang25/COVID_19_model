...
##### sens_policy_2: ONLY change THS start time
...
for (delta_t in delta_t_range){
  ...
  for (ind in 1:n_sample){
    ...
    social_distancing_start = base_line_quarantine_startdate
    ...
    ths_efficiency = 1
    ths_window = 14
    ths_start = base_line_quarantine_startdate + delta_t ###ths: travel history screening
...
save(economy_loss, disease_burden, cum_infected, cum_death, date, delta_t_range, screening_cost, file = "vary_THS_start.rda")
