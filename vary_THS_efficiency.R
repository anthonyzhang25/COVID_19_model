...
################ 
################ sens_param_2: screening efficiency
id = 2
...
for (ths_efficiency in param_range){
  # social_distancing_end = social_distancing_end_vec[ind]
  ratio_ind = as.integer(as.character((ths_efficiency - start)/incre)) + 1
  #### for debug
  cat("ths_efficiency is ",ths_efficiency, "ratio_ind is ", ratio_ind, "\n")
...
save(economy_loss, disease_burden, cum_infected, cum_death, id, param_range, screening_cost, file = "vary_THS_efficiency.rda")
